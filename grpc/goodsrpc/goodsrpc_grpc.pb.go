...
const (
	GoodsService_CheckGoods_FullMethodName = "/goodsrpc.GoodsService/CheckGoods"
)
...
func (c *goodsServiceClient) CheckGoods(ctx context.Context, in *CheckGoodsRequest, opts ...grpc.CallOption) (*CheckGoodsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckGoodsResponse)
	err := c.cc.Invoke(ctx, GoodsService_CheckGoods_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GoodsServiceServer interface {
	CheckGoods(context.Context, *CheckGoodsRequest) (*CheckGoodsResponse, error)
...
func (UnimplementedGoodsServiceServer) CheckGoods(context.Context, *CheckGoodsRequest) (*CheckGoodsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckGoods not implemented")
}
...
func _GoodsService_CheckGoods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckGoodsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsServiceServer).CheckGoods(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GoodsService_CheckGoods_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServiceServer).CheckGoods(ctx, req.(*CheckGoodsRequest))
	}
...
var GoodsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "goodsrpc.GoodsService",
	HandlerType: (*GoodsServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CheckGoods",
			Handler:    _GoodsService_CheckGoods_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pb/goodsrpc.proto",
}
